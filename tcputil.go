...
// Looks for an empty port to listen on local interface.
...
// Wait until you can connect to `addr`, up to `dur` amount of time
...
// Wait until you can connect to `port` on localhost, up to `dur` amount of time
